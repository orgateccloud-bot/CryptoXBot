...
def validar_trade(sinal, preco, capital_usdt):
    ...
    if _estado_risco["bloqueado"]:
        return {"pode": False, "motivo": f"Bot bloqueado: {_estado_risco['motivo_bloqueio']}", "tamanho_btc": 0}
    ...
    if _estado_risco["posicoes_abertas"] >= MAX_POSICOES_ABERTAS:
        return {"pode": False, "motivo": "Posicao ja aberta — aguardar fechamento", "tamanho_btc": 0}
